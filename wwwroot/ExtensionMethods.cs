...
namespace EPiServer.Commerce.Sample
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// <remarks>This extension is indented to use in markup code. For server side, use GetEntryLinkRelative instead. 
        /// GetEntryLinkRelative will handle the case when we're using this site in a virtual directory.</remarks>
        ...
        /// <summary>
        /// Gets the entry link relative.
        /// </summary>
        /// <param name="lineItem">The line item.</param>
        /// <returns></returns>
        public static string GetEntryLinkRelative(this LineItem lineItem)
        {
            return VirtualPathUtilityEx.ToAppRelative(GetEntryLink(lineItem));
        }
