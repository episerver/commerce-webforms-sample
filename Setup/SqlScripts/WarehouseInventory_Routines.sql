...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'dbo' AND ROUTINE_NAME = 'ecf_WarehouseInventory_SetInventories') EXEC dbo.sp_executesql N'DROP PROCEDURE dbo.ecf_WarehouseInventory_SetInventories'
...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'dbo' AND ROUTINE_NAME = 'ecf_WarehouseInventory_DeleteInventories') EXEC dbo.sp_executesql N'DROP PROCEDURE dbo.ecf_WarehouseInventory_DeleteInventories'
...
IF EXISTS (SELECT 1 FROM sys.schemas s join sys.types t on s.schema_id = t.schema_id and s.name = 'dbo' and t.name = 'udttWarehouseId') EXEC dbo.sp_executesql N'DROP TYPE dbo.udttWarehouseId'
